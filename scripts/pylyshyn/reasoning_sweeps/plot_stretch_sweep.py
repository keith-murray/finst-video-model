...
sweep (results/pylyshyn/reasoning_sweeps/stretch_sweep/results.csv, produced by
...
Usage:
    uv run python scripts/pylyshyn/reasoning_sweeps/plot_stretch_sweep.py
"""
...
RESULTS_CSV = "results/pylyshyn/reasoning_sweeps/stretch_sweep/results.csv"
OUT_PATH = "results/pylyshyn/reasoning_sweeps/stretch_sweep/accuracy_summary.png"
