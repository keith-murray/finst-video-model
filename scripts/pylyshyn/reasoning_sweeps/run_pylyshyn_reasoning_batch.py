...
results/pylyshyn/reasoning_sweeps/reasoning_sweep/. results.csv is written incrementally and
...
Usage:
    uv run python scripts/pylyshyn/reasoning_sweeps/run_pylyshyn_reasoning_batch.py
    uv run python scripts/pylyshyn/reasoning_sweeps/run_pylyshyn_reasoning_batch.py --models qwen/qwen3.8-27b
"""
