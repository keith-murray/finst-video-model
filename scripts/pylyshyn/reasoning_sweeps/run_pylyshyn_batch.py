...
(results/pylyshyn/reasoning_sweeps/qwen3.8-27b-low/, vs. the disabled-reasoning
results/pylyshyn/reasoning_sweeps/qwen3.8-27b/ on the same trials) found d' swings from
...
and config.json (small, tracked) go to results/pylyshyn/reasoning_sweeps/<run_name>/.
...
Usage:
    uv run python scripts/pylyshyn/reasoning_sweeps/run_pylyshyn_batch.py
    uv run python scripts/pylyshyn/reasoning_sweeps/run_pylyshyn_batch.py --models qwen/qwen3.8-27b
    uv run python scripts/pylyshyn/reasoning_sweeps/run_pylyshyn_batch.py --models qwen/qwen3.8-27b --run-name qwen3.8-27b-low
"""
