...
results/pylyshyn/stretch_sweep/. results.csv is written incrementally and
re-running resumes automatically (already-run (model, reasoning_level,
variant, seed, probe_on_target) combinations are skipped).

Usage:
    uv run python scripts/pylyshyn/run_pylyshyn_stretch_sweep.py
    uv run python scripts/pylyshyn/run_pylyshyn_stretch_sweep.py --models qwen/qwen3.8-27b
"""
