...
the story: "low" (results/pylyshyn/qwen3.8-27b-low/) vs. fully disabled
(results/pylyshyn/qwen3.8-27b/), where an 18-trial spot check found
...
Usage:
    uv run python scripts/pylyshyn/plot_qwen_summary.py
"""
...
MODEL_RUNS = [
    ("qwen/qwen3.8-27b", "results/pylyshyn/qwen3.8-27b-low/results.csv", "qwen3.8-27b (low reasoning)"),
    ("qwen/qwen3.8-max", "results/pylyshyn/qwen3.8-max/results.csv", "qwen3.8-max (minimal reasoning)"),
    ("qwen/qwen3.8-27b", "results/pylyshyn/qwen3.8-27b/results.csv", "qwen3.8-27b (no reasoning)"),
]
N_OBJECTS_PANELS = [2, 4, 6, 8, 10]
OUT_PATH = "results/pylyshyn/qwen38_summary_percent_error.png"
