...
(`results/pylyshyn/hard_all_models_thinking_sweep/`) so Part 1's results
aren't touched.
...
Usage:
    uv run python scripts/pylyshyn/run_hard_stimuli_thinking_sweep.py
"""
...
RESULTS_DIR = "results/pylyshyn/hard_all_models_thinking_sweep"
