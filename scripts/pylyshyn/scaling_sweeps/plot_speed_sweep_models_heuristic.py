...
Usage:
    uv run python scripts/pylyshyn/scaling_sweeps/plot_speed_sweep_models_heuristic.py
"""
...
MODELS = [
    ("qwen/qwen3.6-plus", "qwen3.6-plus", "results/pylyshyn/scaling_sweeps/speed_sweep/results.csv", "data/pylyshyn/speed_sweep/trials"),
    ("google/gemma-4-31b-it", "gemma-4-31b-it", "results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv", "data/pylyshyn/speed_sweep_models/trials"),
]
OUT_PATH = "results/pylyshyn/scaling_sweeps/speed_sweep_models/accuracy_summary_heuristic.png"
