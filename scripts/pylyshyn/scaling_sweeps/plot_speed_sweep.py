...
sweep on qwen3.6-plus (results/pylyshyn/scaling_sweeps/speed_sweep/results.csv, produced by
...
Usage:
    uv run python scripts/pylyshyn/scaling_sweeps/plot_speed_sweep.py
"""
...
RESULTS_CSV = "results/pylyshyn/scaling_sweeps/speed_sweep/results.csv"
OUT_PATH = "results/pylyshyn/scaling_sweeps/speed_sweep/accuracy_summary.png"
