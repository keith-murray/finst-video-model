...
separate rather than one shared results.csv):
  n_objects=3: results/pylyshyn/scaling_sweeps/speed_sweep/results.csv (qwen3.6-plus, 16
    seeds) + results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv (gemma-4-31b-it,
    20 seeds) -- both already contain all 4 redirect x speed conditions.
  n_objects=4: results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv (both models;
  ...
  n_objects=5: results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv (ditto).
...
Usage:
    uv run python scripts/pylyshyn/scaling_sweeps/plot_nobjects_sweep.py
    uv run python scripts/pylyshyn/scaling_sweeps/plot_nobjects_sweep.py --condition fast
"""
...
SOURCES = {
    (3, "qwen/qwen3.6-plus"): ("results/pylyshyn/scaling_sweeps/speed_sweep/results.csv", "data/pylyshyn/speed_sweep/trials"),
    (3, "google/gemma-4-31b-it"): ("results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv", "data/pylyshyn/speed_sweep_models/trials"),
    (4, "qwen/qwen3.6-plus"): ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv", "data/pylyshyn/nobjects_sweep_n4/trials"),
    (4, "google/gemma-4-31b-it"): ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv", "data/pylyshyn/nobjects_sweep_n4/trials"),
    (5, "qwen/qwen3.6-plus"): ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv", "data/pylyshyn/nobjects_sweep_n5/trials"),
    (5, "google/gemma-4-31b-it"): ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv", "data/pylyshyn/nobjects_sweep_n5/trials"),
}
...
def main():
    ...
    os.makedirs("results/pylyshyn/scaling_sweeps/nobjects_sweep", exist_ok=True)
    out_path = f"results/pylyshyn/scaling_sweeps/nobjects_sweep/accuracy_by_nobjects_{args.condition}.png"
