...
Writes to results/pylyshyn/hard_all_models_sweep/{results.csv,config.json}
-- results.csv written incrementally, re-running resumes automatically
(skips (model, trial_id) pairs already present).

Usage:
    uv run python scripts/pylyshyn/run_hard_stimuli_sweep.py
    uv run python scripts/pylyshyn/run_hard_stimuli_sweep.py --models google/gemma-4-31b-it
"""
...
RESULTS_DIR = "results/pylyshyn/hard_all_models_sweep"
