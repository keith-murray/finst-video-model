...
results/pylyshyn/stretch_sweep/results.csv (32 rows, both variants) --
...
results/pylyshyn/speed_sweep/. results.csv is written incrementally and
...
Usage:
    uv run python scripts/pylyshyn/run_pylyshyn_speed_sweep.py
"""
