...
(results/pylyshyn/reasoning_sweep/results.csv, produced by
...
Colors/chrome follow scripts/pylyshyn/plot_qwen_summary.py's convention
(validated categorical slots 1-2: blue, orange).

Usage:
    uv run python scripts/pylyshyn/plot_reasoning_summary.py
"""
...
RESULTS_CSV = "results/pylyshyn/reasoning_sweep/results.csv"
REASONING_LEVEL_ORDER = ["none", "minimal", "low", "medium", "high"]
MODEL_LABELS = {
    "qwen/qwen3.8-27b": "qwen3.8-27b",
    "qwen/qwen3.8-max": "qwen3.8-max",
}
OUT_PATH = "results/pylyshyn/reasoning_sweep/reasoning_sweep_percent_error.png"
