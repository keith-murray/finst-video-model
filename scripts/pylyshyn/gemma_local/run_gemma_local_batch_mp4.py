...
`scripts/pylyshyn/gemma_local/run_gemma_local_batch.py`, but feeds the model the native
...
scripts/pylyshyn/gemma_local/generate_gemma_local_stimuli.py (alongside video.npy, used
...
scripts/pylyshyn/gemma_local/aggregate_gemma_local_mp4_nobjects_sweep.py, where
