...
`results/pylyshyn/scaling_sweeps/nobjects_sweep/accuracy_by_nobjects_fast.png`'s per-model
...
run-names -- same SOURCES convention as plot_nobjects_sweep.py):
  n_objects=3: results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv
  n_objects=4: results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv
  n_objects=5: results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv
Local data source (all three n_objects):
  results/pylyshyn/gemma_local/gemma_local_nobjects_sweep/results.csv
  (written by aggregate_gemma_local_nobjects_sweep.py).
...
Usage:
    uv run python scripts/pylyshyn/gemma_local/plot_gemma_local_vs_openrouter.py
"""
...
OPENROUTER_SOURCES = {
    3: ("results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv", "data/pylyshyn/speed_sweep_models/trials"),
    4: ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv", "data/pylyshyn/nobjects_sweep_n4/trials"),
    5: ("results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv", "data/pylyshyn/nobjects_sweep_n5/trials"),
}
LOCAL_RESULTS_CSV = "results/pylyshyn/gemma_local/gemma_local_nobjects_sweep/results.csv"
LOCAL_TRIALS_DIR = "data/pylyshyn/gemma_local_nobjects_sweep/trials"
OUT_PATH = "results/pylyshyn/gemma_local/gemma_local_nobjects_sweep/accuracy_by_nobjects.png"
