...
results/pylyshyn/gemma_local/host_sweep/. results.csv is written incrementally and
re-running resumes automatically.

Usage:
    uv run python scripts/pylyshyn/gemma_local/run_pylyshyn_host_sweep.py
    uv run python scripts/pylyshyn/gemma_local/run_pylyshyn_host_sweep.py --hosts coreweave crusoe
"""
...
def main():
    ...
    results_dir = os.path.join("results", "pylyshyn", "gemma_local", RUN_NAME)
