...
Data sources:
  ...
  Local, mp4 (new, all three n_objects):
    results/pylyshyn/gemma_local/gemma_local_mp4_nobjects_sweep/results.csv
...
Usage:
    uv run python scripts/pylyshyn/gemma_local/plot_gemma_local_mp4_vs_all.py
"""
...
OPENROUTER_SOURCES = {
    3: "results/pylyshyn/scaling_sweeps/speed_sweep_models/results.csv",
    4: "results/pylyshyn/scaling_sweeps/nobjects_sweep_n4/results.csv",
    5: "results/pylyshyn/scaling_sweeps/nobjects_sweep_n5/results.csv",
}
LOCAL_MP4_RESULTS_CSV = "results/pylyshyn/gemma_local/gemma_local_mp4_nobjects_sweep/results.csv"
LOCAL_NPY_RESULTS_CSV = "results/pylyshyn/gemma_local/gemma_local_nobjects_sweep/results.csv"
LOCAL_TRIALS_DIR = "data/pylyshyn/gemma_local_nobjects_sweep/trials"
OUT_PATH = "results/pylyshyn/gemma_local/gemma_local_mp4_nobjects_sweep/accuracy_by_nobjects_mp4_vs_all.png"
