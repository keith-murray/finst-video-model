...
`scripts/pylyshyn/gemma_local/plot_gemma_local_vs_openrouter.py`.

Usage:
    uv run python scripts/pylyshyn/gemma_local/plot_host_sweep.py
"""
...
RESULTS_CSV = "results/pylyshyn/gemma_local/host_sweep/results.csv"
TRIALS_DIR = "data/pylyshyn/host_sweep/trials"
OUT_PATH = "results/pylyshyn/gemma_local/host_sweep/accuracy_by_nobjects_hosts.png"
