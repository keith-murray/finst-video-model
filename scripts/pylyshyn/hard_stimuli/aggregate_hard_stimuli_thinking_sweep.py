"""
Aggregates `run_hard_stimuli_thinking_sweep.py`'s results.csv into a
per-model accuracy/d'/cost summary, per `claude/2026_09/2026_09_16/
TODO.md`'s Part 2. Direct mirror of `aggregate_hard_stimuli_sweep.py`
(Part 1) pointed at the reasoning="medium" results directory instead.

Writes results/pylyshyn/hard_stimuli/hard_all_models_thinking_sweep/summary.json.

Usage:
    uv run python scripts/pylyshyn/hard_stimuli/aggregate_hard_stimuli_thinking_sweep.py
"""
...
RESULTS_CSV = "results/pylyshyn/hard_stimuli/hard_all_models_thinking_sweep/results.csv"
TRIALS_ROOT = "data/pylyshyn/hard_all_models_sweep/trials"
OUT_PATH = "results/pylyshyn/hard_stimuli/hard_all_models_thinking_sweep/summary.json"
