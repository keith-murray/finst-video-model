...
Usage:
    uv run python scripts/pylyshyn/hard_stimuli/plot_hard_stimuli_thinking_sweep.py
"""
...
NO_REASONING_SUMMARY = "results/pylyshyn/hard_stimuli/hard_all_models_sweep/summary.json"
REASONING_SUMMARY = "results/pylyshyn/hard_stimuli/hard_all_models_thinking_sweep/summary.json"
OUT_PATH = "results/pylyshyn/hard_stimuli/hard_all_models_thinking_sweep/accuracy_no_reasoning_vs_medium_reasoning.png"
