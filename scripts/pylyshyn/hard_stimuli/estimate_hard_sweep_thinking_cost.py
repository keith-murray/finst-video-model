...
Usage:
    uv run python scripts/pylyshyn/hard_stimuli/estimate_hard_sweep_thinking_cost.py
    uv run python scripts/pylyshyn/hard_stimuli/estimate_hard_sweep_thinking_cost.py --pilot-n 5
"""
