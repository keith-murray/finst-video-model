...
Writes results/pylyshyn/hard_all_models_sweep/summary.json.

Usage:
    uv run python scripts/pylyshyn/aggregate_hard_stimuli_sweep.py
"""
...
RESULTS_CSV = "results/pylyshyn/hard_all_models_sweep/results.csv"
TRIALS_ROOT = "data/pylyshyn/hard_all_models_sweep/trials"
OUT_PATH = "results/pylyshyn/hard_all_models_sweep/summary.json"
