...
`scripts/pylyshyn/run_pylyshyn_host_sweep.py` --
...
Writes to results/pylyshyn/gemma_local_n4_heuristic_chance/openrouter/
...
Usage:
    uv run python scripts/pylyshyn/run_gemma_local_n4_heuristic_chance_openrouter.py
"""
...
RESULTS_DIR = "results/pylyshyn/gemma_local_n4_heuristic_chance/openrouter"
