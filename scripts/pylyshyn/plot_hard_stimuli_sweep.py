...
Usage:
    uv run python scripts/pylyshyn/plot_hard_stimuli_sweep.py
"""
...
SUMMARY_PATH = "results/pylyshyn/hard_all_models_sweep/summary.json"
OUT_PATH = "results/pylyshyn/hard_all_models_sweep/accuracy_by_model.png"
