...
scripts/pylyshyn/run_gemma_local_batch_mp4.py on the cluster, then rsynced
...
scripts/pylyshyn/aggregate_gemma_local_nobjects_sweep.py -- same trial dirs
...
Usage:
    uv run python scripts/pylyshyn/aggregate_gemma_local_mp4_nobjects_sweep.py
"""
...
def main():
    ...
    parser.add_argument(
        "--out-root", type=str, default="results/pylyshyn/gemma_local_mp4_nobjects_sweep",
    )
