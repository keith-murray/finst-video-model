...
Usage:
    uv run python scripts/pylyshyn/generate_gemma_local_n4_heuristic_chance_stimuli.py
"""
...
REPORT_PATH = "results/pylyshyn/gemma_local_n4_heuristic_chance/generation_report.json"
