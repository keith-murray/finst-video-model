...
written by scripts/pylyshyn/generate_gemma_local_stimuli.py and rsynced up.
...
finst_video_model.pylyshyn.stimulus_gen.generate_stimulus).
    ...
    rsync -av scripts/pylyshyn/run_gemma_local_batch.py \\
...
scripts/pylyshyn/aggregate_gemma_local_nobjects_sweep.py, where
