...
Usage:
    uv run python scripts/pylyshyn/estimate_hard_sweep_cost.py
    uv run python scripts/pylyshyn/estimate_hard_sweep_cost.py --pilot-n 5
"""
...
OUT_PATH = "results/pylyshyn/hard_all_models_sweep/cost_estimate.json"
